...
const offerTexts = {
    ...
    permissions: {
        ...
        description: <>Nasza działalność opiera się na solidnych fundamentach prawnych i certyfikowanych kompetencjach.
            Posiadamy wszelkie niezbędne uprawnienia, które gwarantują naszym Klientom najwyższy standard usług oraz
            pełne bezpieczeństwo i poufność powierzonych informacji.</>,
        features: [
            {
                title: "Koncesja MSWiA",
                content: <>Posiadamy koncesję L-0602/00 uprawniającą do prowadzenia działalności gospodarczej w zakresie
                    zabezpieczenia technicznego.</>
            },
            {
                title: "Świadectwo Bezpieczeństwa przemysłowego ABW",
                content: <>Poświadcza naszą wiarygodność i zdolność do ochrony informacji niejawnych, gwarantując
                    zachowanie tajemnicy i poufności (ŚBP II stopnia - POUFNE).</>
            },
            {
            ...
            },
            {
                ...
                content: <>Nasz sprzęt posiada akredytację bezpieczeństwa teleinformatycznego, co pozwala na bezpieczne
            ...
            },
            {
                ...
                content: <>Nasz zespół uzupełnia inspektor bezpieczeństwa teleinformatycznego, który administruje i
                    chroni nasze systemy informatyczne.</>
            }
        ]
    },
    additional: {
